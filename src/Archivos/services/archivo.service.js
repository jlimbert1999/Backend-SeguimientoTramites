...
exports.archiveMail = async (mail, funcionario, dependencia, descripcion) => {
...
exports.archiveProcedure = async (tipo, id_tramite, id_funcionario, id_dependencia, descripcion) => {
    const archive = {
        tramite: id_tramite,
        tipo,
...
exports.get = async (id_dependencia) => {
...
exports.unarchive = async (id_archivo, funcionario, descripcion) => {
